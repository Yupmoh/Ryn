...
internal sealed class DeferredRynWindow(RynWindowAccessor accessor) : IRynWindow
{
    ...
    public void SetPageZoom(double factor) => Live.SetPageZoom(factor);
    public double GetPageZoom() => Live.GetPageZoom();
    ...
    public void BeginNativeDrag(double x, double y) => Live.BeginNativeDrag(x, y);
